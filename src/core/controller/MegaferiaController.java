...
public class MegaferiaController implements Observable {
    ...
    /**
     * 2. Registra un nuevo autor validando campos obligatorios, formato del ID
     * y unicidad dentro del sistema.
     */
    ...
    // ---------------------------------------------------------------------
    /**
     * Registra un narrador mediante validación de campos básicos y verificación
     * de unicidad.
     */
    ...
    // ---------------------------------------------------------------------
    /**
     * Registra una editorial asociándola a un gerente existente. Verifica
     * unicidad del NIT y consistencia de la relación.
     */
